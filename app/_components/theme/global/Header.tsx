        ...
        <div className={isOpenMenuSlider ? `lg:hidden shadow-2xl fixed top-0 left-0 min-h-dvh min-w-3/4 bg-[var(--background)] z-50 translate-x-0 transition-all` : `lg:hidden shadow-2xl fixed top-0 left-0 min-h-dvh min-w-3/4 bg-[var(--background)] z-50 -translate-x-[100%] transition-all`}>
            <div className="p-5 relative">
                ...
                <div className="flex space-x-5 justify-start items-center mb-14">
                    <Link href="https://www.instagram.com/pistorium.official/" target="_blank" className="block text-yellow-50 transition-all duration-500">
                    ...
                    <Link href="https://facebook.com" target="_blank" className="block text-yellow-50 transition-all duration-500">
                    ...
                    <Link href="https://youtube.com" target="_blank" className="block text-yellow-50 transition-all duration-500">
