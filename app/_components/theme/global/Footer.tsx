        ...
        <footer className="w-full py-14 bg-[var(--background)] font-poppins">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto">
                    <Link href={"/"} title="Pistorium" className="flex justify-center">
                        <Image
                            className=""
                            src="/main-logo.png"
                            alt="Opera Cake"
                    ...
                    <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-10 mb-10 border-b border-gray-200">
                        <li>
                            <Link href="/" className="text-[var(--foreground)] hover:text-yellow-100">
                            {"Home"}
                            </Link>
                        </li>
                        <li>
                            <Link href="#brownies" className=" text-[var(--foreground)] hover:text-yellow-100">
                            {"Brownies"}
                            </Link>
                        </li>
                        <li>
                            <Link href="#cakes" className=" text-[var(--foreground)] hover:text-yellow-100">
                            {"Cakes"}
                            </Link>
                        </li>
                        <li>
                            <Link href="#theme-cakes" className=" text-[var(--foreground)] hover:text-yellow-100">
                            {"Theme Cakes"}
                            </Link>
                        </li>
                        <li>
                            <Link href="#chocolates" className=" text-[var(--foreground)] hover:text-yellow-100">
                            {"Chocolates"}
                            </Link>
                        </li>
                    </ul>
                    <div className="flex space-x-10 justify-center items-center mb-14">
                        <a href="https://www.instagram.com/pistorium.official/" target="_blank" className="block  text-[var(--foreground)] transition-all duration-500">
                        ...
                        <a href="https://facebook.com" target="_blank" className="block  text-[var(--foreground)] transition-all duration-500 ">
                        ...
                        <a href="https://youtube.com" target="_blank" className="block  text-[var(--foreground)] transition-all duration-500">
                    ...
                    <span className="text-lg text-[var(--foreground)] text-center block">
