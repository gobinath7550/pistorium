            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="flex space-x-10 justify-center items-center mb-14">
                        <a href="https://www.instagram.com/pistorium.official/" target="_blank" className="block  text-yellow-50 transition-all duration-500">
                        ...
                        <a href="https://facebook.com" target="_blank" className="block  text-yellow-50 transition-all duration-500 ">
                        ...
                        <a href="https://youtube.com" target="_blank" className="block  text-yellow-50 transition-all duration-500">
